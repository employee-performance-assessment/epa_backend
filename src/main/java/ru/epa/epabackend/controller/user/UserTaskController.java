...
/**
 * Класс содержит эндпойнты для атворизованного пользователя, относящиеся к задачам
 *
 * @author Владислав Осипов
 */
@SecurityRequirement(name = "JWT")
@Tag(name = "Private: Задачи", description = "API пользователя для работы с задачами")
@RestController
...
public class UserTaskController {
    ...
    /**
     * Получение всех задач по email сотрудника с возможной фильтрацией по статусу задачи,
    ...
    /**
     * Получение информации о задаче сотрудником
     */
    ...
    /**
     * Обновление статуса выполнения задачи сотрудником
     */
    ...
    /**
     * Получение всех задач сотрудником для канбан доски. Видим все задачи всех сотрудников админа
     */
    @Operation(summary = "Получение всех задач сотрудником для канбан доски. Видим все задачи всех сотрудников админа.",
