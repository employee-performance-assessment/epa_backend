...
public class AdminProjectController {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public ResponseProjectSaveWithEmployeeDto saveWithEmployee(@PathVariable Long projectId,
    ...
    public List<ResponseEmployeeShortDto> findByProjectIdAndRole(@PathVariable Long projectId, Principal principal) {
