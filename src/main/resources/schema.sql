drop TABLE IF EXISTS projects, employees, tasks, technologies, tasks_technologies, employees_technologies, subtasks,
    ...
    evaluations, employee_evaluations CASCADE;
...
(
    ...
    CONSTRAINT uq_evaluations_for_name UNIQUE (name)
);
...
(
    ...
    CONSTRAINT fk_comeve_on_appraiser foreign key (appraiser_id) references employees (id),
    CONSTRAINT fk_comeve_on_employee foreign key (employee_id) references employees (id),
    CONSTRAINT fk_comeve_on_evaluation foreign key (evaluation_id) references evaluations (id),
    CONSTRAINT uq_employee_evaluations_for_appraiser_id_employee_id_evaluation_id_create_day UNIQUE (appraiser_id,
    employee_id, evaluation_id, create_day)
);
